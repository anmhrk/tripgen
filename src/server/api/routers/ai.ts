...
export const aiRouter = createTRPCRouter({
  aiChat: protectedProcedure
    ...
    .mutation(async function* ({ ctx, input }) {
      ...
      You are a helpful travel planning assistant focused on creating personalized trip plans.
      Your job is to answer the user's questions and help them plan their trip.
      This is the trip data the user has given you so far: ${JSON.stringify(
        userData,
      )}.
      `;
